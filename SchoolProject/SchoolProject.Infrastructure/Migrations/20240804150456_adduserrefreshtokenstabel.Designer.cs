...
namespace SchoolProject.Infrastructure.Migrations
{
    ...
    [Migration("20240804150456_adduserrefreshtokenstabel")]
    partial class adduserrefreshtokenstabel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolProject.Data.Entityes.Identity.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("userRefreshTokens", "School");
                });
            ...
            modelBuilder.Entity("SchoolProject.Data.Entityes.Identity.UserRefreshToken", b =>
                {
                    b.HasOne("SchoolProject.Data.Entityes.Identity.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
